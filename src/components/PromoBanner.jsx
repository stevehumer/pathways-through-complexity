...
export const PromoBanner = () => {
  ...
  return (
    <div className="bg-blue-100 text-blue-900 text-center py-3 px-4 shadow-md mt-14 md:mt-16">
      📚 <strong>Free eBook!</strong> Download <em>“The Challenges at Azelica”</em> for free from <strong>Nov 14 - Nov 18, 2025</strong>. First book in the <em>Bine Ari Digit</em> fiction series! 👉{" "}
      <a
