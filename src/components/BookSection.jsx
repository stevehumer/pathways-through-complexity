...
export const BookSection = () => {
    ...
    return (
        <section className="text-gray-600 body-font pt-8 md:pt-8 lg:pt-6">
            ...
            <div className="container mx-auto px-5 py-6 max-w-5xl">
                ...
                <div className="flex flex-col md:flex-row justify-between">
                    {[
                        { title: "Book 1: The Challenges at Azelica", img: azelicaBookCover, link: "https://www.amazon.com/Challenges-Azelica-BAD-Adventures-Fable-ebook/dp/B0CP2QHQYC", description: 
